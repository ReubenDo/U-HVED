...
def __add_multimodal_args(parser):

    """
    keywords defined for mutlimdodal tasks
    ...
    parser = add_input_name_args(parser, ['choices', 'output_mod'])
    return parser
...
SUPPORTED_ARG_SECTIONS = {
    ...
    'MULTIMODAL': __add_multimodal_args,
}
